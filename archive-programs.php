...
<section class="bg-white dark:bg-gray-900 font-mono">
  ...
  <div
    class="relative flex h-full transform items-end border-2 border-slate rounded-lg bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
    <div
