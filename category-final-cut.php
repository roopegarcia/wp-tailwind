...
<div class="prose max-w-4xl mx-auto flex-auto text-slate">
  <h1 class="text-center p-10 mb-8 uppercase border-black text-black">Final Cut</h1>
  <h3 class="text-center uppercase text-slate-500">Read everything about my journey to never having to cut again.<br /> My quest for eternal maintenance.</h3>
